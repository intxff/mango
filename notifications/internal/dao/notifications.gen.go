...
func newNotification(db *gorm.DB, opts ...gen.DOOption) notification {
	...
	_notification.NotificationID = field.NewUint64(tableName, "notification_id")
	_notification.Status = field.NewString(tableName, "status")
	_notification.Class = field.NewString(tableName, "class")
	_notification.UserID = field.NewUint64(tableName, "user_id")
	_notification.ObjectID = field.NewUint64(tableName, "object_id")
...
func (n *notification) updateTableName(table string) *notification {
	...
	n.NotificationID = field.NewUint64(table, "notification_id")
	n.Status = field.NewString(table, "status")
	n.Class = field.NewString(table, "class")
...
func (n notificationDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) INotificationDo {
