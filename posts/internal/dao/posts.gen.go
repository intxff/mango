...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.PostID = field.NewUint64(tableName, "post_id")
	_post.UserID = field.NewUint64(tableName, "user_id")
	_post.UserIP = field.NewBytes(tableName, "user_ip")
	_post.ScopeID = field.NewUint64(tableName, "scope_id")
	_post.CategoryID = field.NewUint64(tableName, "category_id")
	...
	_post.Class = field.NewString(tableName, "class")
	_post.Status = field.NewString(tableName, "status")
	_post.Parent = field.NewUint64(tableName, "parent")
	_post.AllowedUserRole = field.NewString(tableName, "allowed_user_role")
	_post.CommentStatus = field.NewString(tableName, "comment_status")
	_post.ViewsCount = field.NewUint32(tableName, "views_count")
...
type post struct {
	...
	Status          field.String
	Parent          field.Uint64
	AllowedUserRole field.String
	CommentStatus   field.String
	ViewsCount      field.Uint32
...
func (p *post) updateTableName(table string) *post {
	...
	p.UserIP = field.NewBytes(table, "user_ip")
	p.ScopeID = field.NewUint64(table, "scope_id")
	p.CategoryID = field.NewUint64(table, "category_id")
	p.Title = field.NewString(table, "title")
	p.Excerpt = field.NewString(table, "excerpt")
	p.Content = field.NewString(table, "content")
	p.Class = field.NewString(table, "class")
	p.Status = field.NewString(table, "status")
	p.Parent = field.NewUint64(table, "parent")
	p.AllowedUserRole = field.NewString(table, "allowed_user_role")
	p.CommentStatus = field.NewString(table, "comment_status")
	p.ViewsCount = field.NewUint32(table, "views_count")
...
func (p *post) fillFieldMap() {
	...
	p.fieldMap["allowed_user_role"] = p.AllowedUserRole
	p.fieldMap["comment_status"] = p.CommentStatus
	p.fieldMap["views_count"] = p.ViewsCount
