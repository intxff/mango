...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.CategoryID = field.NewUint64(tableName, "category_id")
	_category.Name = field.NewString(tableName, "name")
	_category.Slogan = field.NewString(tableName, "slogan")
	_category.Description = field.NewString(tableName, "description")
	_category.Parent = field.NewUint64(tableName, "parent")
	_category.PostsCount = field.NewUint64(tableName, "posts_count")
...
func (c *category) updateTableName(table string) *category {
	...
	c.Slogan = field.NewString(table, "slogan")
	c.Description = field.NewString(table, "description")
	c.Parent = field.NewUint64(table, "parent")
	c.PostsCount = field.NewUint64(table, "posts_count")
...
func (c *category) fillFieldMap() {
	...
	c.fieldMap["slogan"] = c.Slogan
	c.fieldMap["description"] = c.Description
	c.fieldMap["parent"] = c.Parent
	c.fieldMap["posts_count"] = c.PostsCount
