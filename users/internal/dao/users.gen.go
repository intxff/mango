...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Slogan = field.NewString(tableName, "slogan")
	_user.Role = field.NewString(tableName, "role")
	_user.FollowersCount = field.NewInt32(tableName, "followers_count")
	_user.FollowingCount = field.NewInt32(tableName, "following_count")
	_user.LikeCount = field.NewInt32(tableName, "like_count")
	_user.DislikeCount = field.NewInt32(tableName, "dislike_count")
	_user.PostsCount = field.NewInt32(tableName, "posts_count")
	_user.Online = field.NewBool(tableName, "online")
...
type user struct {
	...
	Slogan         field.String
	Role           field.String
	FollowersCount field.Int32
	FollowingCount field.Int32
	LikeCount      field.Int32
	DislikeCount   field.Int32
	PostsCount     field.Int32
	Online         field.Bool
...
func (u *user) updateTableName(table string) *user {
	...
	u.Slogan = field.NewString(table, "slogan")
	u.Role = field.NewString(table, "role")
	u.FollowersCount = field.NewInt32(table, "followers_count")
	u.FollowingCount = field.NewInt32(table, "following_count")
	u.LikeCount = field.NewInt32(table, "like_count")
	u.DislikeCount = field.NewInt32(table, "dislike_count")
	u.PostsCount = field.NewInt32(table, "posts_count")
	u.Online = field.NewBool(table, "online")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["slogan"] = u.Slogan
	u.fieldMap["role"] = u.Role
	u.fieldMap["followers_count"] = u.FollowersCount
	u.fieldMap["following_count"] = u.FollowingCount
	u.fieldMap["like_count"] = u.LikeCount
	u.fieldMap["dislike_count"] = u.DislikeCount
	u.fieldMap["posts_count"] = u.PostsCount
	u.fieldMap["online"] = u.Online
