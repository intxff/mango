...
func init() {
	...
	if err != nil {
		fmt.Printf("Error: AutoMigrate(&models.Tag{}) fail: %s", err)
	}
}
...
func Test_tagQuery(t *testing.T) {
	...
	err = _do.Create(&models.Tag{})
	if err != nil {
		t.Error("create item in table <tags> fail:", err)
	}

	err = _do.Save(&models.Tag{})
	if err != nil {
		t.Error("create item in table <tags> fail:", err)
	}

	err = _do.CreateInBatches([]*models.Tag{{}, {}}, 10)
	if err != nil {
		t.Error("create item in table <tags> fail:", err)
	}
	...
	err = _do.Where(primaryKey.IsNotNull()).FindInBatches(&[]*models.Tag{}, 10, func(tx gen.Dao, batch int) error { return nil })
	if err != nil {
	...
	_, err = _do.ScanByPage(&models.Tag{}, 0, 1)
	if err != nil {
